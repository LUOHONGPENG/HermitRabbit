...
public class ConvertWindow : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        //Button控件上的文字位置
        alignLeft.alignment = TextAnchor.LowerCenter;
...
public class Gif2Sprite : AssetPostprocessor
{
    ...
    {
        //assetPath为导入文件夹后文件的路径，例如assets/gifimporter/gif2sprite/bb8.gif
        //string.ToLower()为将string类型转换为小写的
